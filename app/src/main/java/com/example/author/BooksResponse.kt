...
//file ini adalah model dari data yang akan kita ambil, file ini juga berfungsi sebagai API endpoint = berfungsi untuk merequest atau mengambil data dari internet.